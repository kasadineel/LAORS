...
-- CreateIndex
CREATE INDEX "Event_animalId_idx" ON "Event"("animalId");
...
-- AddForeignKey
ALTER TABLE "Event" ADD CONSTRAINT "Event_animalId_fkey" FOREIGN KEY ("animalId") REFERENCES "Animal"("id") ON DELETE SET NULL ON UPDATE CASCADE;
